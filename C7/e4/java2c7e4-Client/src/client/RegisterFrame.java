...
public class RegisterFrame extends javax.swing.JFrame {
    ...
    public RegisterFrame() {
        initComponents();
        jButton1.addActionListener(event -> register());
    ...
    private void register(){
        ...
        boolean result = ConnectionController.getInstance().register(username, password);
        
        if (result){
            JOptionPane.showMessageDialog(null, "User created");
        } else {
            JOptionPane.showMessageDialog(null, "User failed");
        }
    }
